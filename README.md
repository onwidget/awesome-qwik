...
- [create-vite/template-qwik](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-qwik) - Vite's pure JavaScript starter for Qwik. Run: `npx create-vite some-dir --template qwik`.
- [create-vite/template-qwik-ts](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-qwik) - Vite's TypeScript starter for Qwik. Run: `npx create-vite some-dir --template qwik-ts`.
